...
from duet.duetx.film_timing import trim_shot_media
from duet.duetx.h3_prompt import H3_PROMPT_FORMAT
from duet.duetx.story_contracts import ShotIntent
from duet.duetx.story_memory_backend import StorySampler
from duet.duetx.story_video_canvas import H3_FIRST_FRAME_CROP, H3_FIRST_FRAME_METHOD
...
class DuetH3BalancedCache(io.ComfyNode):
    ...
    def execute(cls, model: Any) -> Any:
        ...
        from duet.duetx.h3_acceleration import patch_h3_balanced
