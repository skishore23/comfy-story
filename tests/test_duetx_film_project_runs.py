...
def test_runtime_identity_covers_story_and_memory_implementation(
    ...
    assert "duetx/story_service.py" in hashes
    assert "duetx/story_memory_backend.py" in hashes
    monkeypatch.setattr(
        film_project_runs,
        "file_digest",
