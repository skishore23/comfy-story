...
import * as state from '../../integrations/comfyui_duetx_continuity/web/story_state.mjs'

// Execute the actual panel lifecycle; helper-only tests miss serialization hooks.
const source = readFileSync(new URL('../../integrations/comfyui_duetx_continuity/web/duet_story_panel_v2.js', import.meta.url), 'utf8').replace(/^import .*\n/gm, '')
