...
def test_h3_frame_format_preserves_language_and_matches_images(ending: bool) -> None:
    from comfy_story.h3_prompt import compile_h3_prompt
...
def test_h3_film_direction_uses_visible_facts_without_review_jargon() -> None:
    from comfy_story.film_plan import FilmFact, FilmPlan, FilmShot, FilmStateDefinition
    from comfy_story.h3_prompt import film_h3_direction
