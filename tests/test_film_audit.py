...
from comfy_story.film_audit import parse_visual_audit, sample_frame_indices, visual_audit_prompt
from comfy_story.film_plan import FilmFact, FilmShot
...
def test_matching_opening_does_not_clear_other_visual_rejections(status: str) -> None:
    from comfy_story.film_audit import ShotVisualAudit, apply_opening_conditions
...
def test_opening_observations_reject_malformed_or_unrequested_facts(response: str) -> None:
    from comfy_story.film_audit import parse_opening_conditions
...
def test_camera_observations_reject_invalid_frames_labels_and_missing_evidence(
    ...
    from comfy_story.film_audit import parse_camera_observations
...
def test_preserved_conditions_are_also_checked_in_the_opening() -> None:
    from comfy_story.film_audit import condition_scopes
...
def test_opening_observer_cannot_see_the_preferred_value_or_future_action(tmp_path: Path) -> None:
    from comfy_story.film_audit_cli import _opening_content
