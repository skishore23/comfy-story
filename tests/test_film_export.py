...
from comfy_story.film_export import export_film, file_digest
from comfy_story.film_plan import AcceptedTake, FilmPlan, FilmShot
...
def test_spoken_export_checks_cue_coverage_and_uses_authored_caption(tmp_path: Path) -> None:
    ...
    from comfy_story.film_export import FilmAudio
...
def test_generated_cue_windows_duck_only_the_soundtrack() -> None:
    from comfy_story.film_export import _speech_duck_expression
