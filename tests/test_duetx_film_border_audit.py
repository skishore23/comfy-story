...
from duet.duetx.film_border_audit import apply_border_policy, black_borders
from duet.duetx.film_io import film_plan_from_json
from duet.duetx.film_plan import FilmPlan, FilmShot, compile_candidate_prompt
...
def test_export_audit_detects_encoded_bars_despite_model_pass(tmp_path: Path) -> None:
    ...
    from duet.duetx.film_plan import RenderedTake
