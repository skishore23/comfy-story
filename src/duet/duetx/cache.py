"""Fixed-slot logarithmic updates over authoritative Duet-X history leaves."""
...
from duet.duetx.contracts import Coverage, DuetXContract, ExceptionItem, LeafKey
from duet.duetx.selection import canonicalize_items
from duet.duetx.state import DuetXState, identity_state, leaf_state, merge_states
...
class DuetXProductTree:
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(contract, DuetXContract):
        ...
        self._levels: list[list[DuetXState]] = [
    ...
    @property
    def contract(self) -> DuetXContract:
    ...
    def full_rebuild_root(self) -> DuetXState:
    ...
    def _state_for_slot(self, slot: int) -> DuetXState:
