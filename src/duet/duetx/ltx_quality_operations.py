...
from duet.duetx.media_probe import (
    DecodedMediaFacts,
...
def create_source_archive(
    ...
    *,
    ...
    bootstrap_relative = "src/duet/duetx/ltx_quality_bootstrap.py"
...
def prepare_operational_run(
    ...
    *,
    ...
    from duet.duetx.ltx_quality_runtime import (
...
def verify_loaded_duet_module_origins(
    ...
    *,
    ...
    for name, module in tuple(modules.items()):
        if name != "duet" and not name.startswith("duet."):
            continue
...
def execute_operational_phase(
    ...
    *,
    ...
    verify_loaded_duet_module_origins(
        ...
        source_receipt,
        required_modules=(
            "duet.duetx.contracts",
            "duet.duetx.ltx_quality_generation",
            "duet.duetx.ltx_quality_operations",
            "duet.duetx.ltx_quality_protocol",
            "duet.duetx.ltx_quality_scenes",
            "duet.duetx.media_probe",
        ),
    )
    ...
    verify_loaded_duet_module_origins(
        ...
        source_receipt,
        required_modules=(
            "duet.duetx.ltx_media",
            "duet.duetx.ltx_quality_runtime",
        ),
    )
