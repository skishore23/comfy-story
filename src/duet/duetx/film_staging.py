...
from duet.duetx.film_plan import FilmPlan
from duet.duetx.film_runner import _json_request, _write
from duet.duetx.film_selected_state import ShotStateBinding
from duet.duetx.film_staging_workflow import (
    STAGING_MODELS,
    STAGING_PROTOCOL,
    compile_opening_stage,
    opening_stage_prompt,
)
from duet.duetx.film_starting_state import check_starting_state
...
from duet.duetx.story_video_canvas import (
    H3_FIRST_FRAME_CROP,
